...
class Serverless(object):
    ...
    def exit(self):
        self.stats()
        print("Shutting down Serverless")
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print("{0} Serverless strikes hit. ({1} Failed)".format(self.counter[0], self.counter[1]))
...
def usage():
    ...
    print(SERVERLESS_DESC)
    print()
    print(' USAGE: ./serverless.py <url> [OPTIONS]')
    print()
    print(' OPTIONS:')
...
def main():
    ...
    try:
        ...
        serverless = Serverless(url)
        serverless.useragents = useragents
        serverless.nr_workers = workers
        serverless.method = method
        serverless.nr_sockets = socks
